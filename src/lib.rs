...
#[derive(Debug)]
pub struct MetaAuthProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaAuthProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaAuth processing");
    
    let mut processor = MetaAuthProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaAuthProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaAuthProcessor::new(false);
